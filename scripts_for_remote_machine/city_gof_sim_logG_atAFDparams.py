...
with open(combined_params_path+'city_logG_atAFD_fitvals.pkl', 'rb') as handle:
...
with open(combined_params_path+'city_logG_atAFD_fit_and_simvals.pkl', 'wb') as handle:
